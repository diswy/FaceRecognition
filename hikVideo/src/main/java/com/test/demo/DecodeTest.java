...
public class DecodeTest {
	...
	public static void WinDecInfo(int iUserID)
	{
        ...
        //锟斤拷锟斤拷锟斤拷锟叫达拷锟节ｏ拷锟接达拷锟节号革拷值锟斤拷conditionArray锟斤拷锟斤拷锟斤拷锟斤拷锟绞碉拷实锟斤拷哟锟斤拷锟斤拷锟斤拷锟�
        ...
        for (VideoWallWindow window : windowList)
        {
            ...
            {
                //锟斤拷1锟街斤拷墙锟斤拷+1锟街斤拷锟接达拷锟节猴拷+2锟街节达拷锟节号ｏ拷锟斤拷锟接达拷锟节号达拷1锟斤拷始
        ...
        //锟斤拷锟斤拷一锟斤拷subWindowCount锟斤拷小锟斤拷锟斤拷锟介（锟斤拷锟斤拷SDK锟接口ｏ拷锟斤拷锟斤拷conditionArray锟斤拷锟斤拷锟斤拷锟斤拷
